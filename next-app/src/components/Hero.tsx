          ...
          <div className="space-y-8">
            ...
            <div className="flex flex-wrap gap-4">
              <button
                ...
                className="inline-flex items-center gap-2 bg-brand-500 hover:bg-brand-400 text-slate-950 font-semibold px-6 py-3 rounded-xl transition-all hover:shadow-xl hover:shadow-brand-500/25 cursor-pointer"
              >
